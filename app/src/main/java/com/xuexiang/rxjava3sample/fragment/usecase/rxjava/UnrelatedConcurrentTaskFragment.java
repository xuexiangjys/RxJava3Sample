...
/***
 * 使用merge将前后无依赖的任务并行关联起来
 *
 * 这里的并行任务，每个任务独立运行，独立输出（一般都是同类输出）
 */
@Page(name = "Unrelated Concurrent Task\n无关联的并行任务(merge)，n个输入n个输出")
public class UnrelatedConcurrentTaskFragment extends UseCaseTestFragment {
